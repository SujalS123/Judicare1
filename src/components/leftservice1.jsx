...
const ServiceSection = (props) => {
    ...
    const handleButtonClick = () => {
        navigate('/casetracker');
    };

    return (
        <div className="min-h-[calc(100vh-17rem)] flex flex-col md:flex-row items-center justify-between p-30 bg-gradient-to-b from-orange-100 to-green-100 box-border">
